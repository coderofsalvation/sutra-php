...
var nicEditorInstance = bkClass.extend({
  ...
  cleanupContent: function() {
    ...
    switch( cmd ){
      case "removeformat": this.ne.selectedInstance.cleanupContent(); break;
    }
	}		
});
...
var nicEditorAdvancedButton = nicEditorButton.extend({
	...
	addForm : function(f,elm) {
		...
		new bkElement('input').setAttributes({'type' : 'submit', 'value': 'Opslaan'}).setStyle({backgroundColor : '#efefef',border : '1px solid #ccc', margin : '3px 0', 'float' : 'left', 'clear' : 'both'}).appendTo(this.form);
...
//unicEditors.registerPlugin(nicPlugin,nicImageOptions);
