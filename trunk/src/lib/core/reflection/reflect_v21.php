<?php
	/*
        ...
        merge           optional    Output image contains both source and reflection? (boolean, default false)
	*/
    
    //  Image Flow users - If you wuold like to hard-code the background colour into this script, do so here by
    //  uncommenting the following line and changing the colour value to whatever you need:
	...
	if (isset($_GET['img']))
	{
		...
		$source_image = dirname(__FILE__)."/".$source_image;
	...
	if (isset($_GET['bgc']) == false && isset($bgc) == false)
	{
		$red = 255;
		$green = 255;
		$blue = 255;
