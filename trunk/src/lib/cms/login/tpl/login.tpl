...
<div name="page" class="cmsunit13 block border curved fill padding last">
    {uicomponent  type="normal" label=`#username#` label_id="username" advanced=false}       
      <input type="text" id="username" name="username" class="required cmsunit06 last">
    {/uicomponent}
    ...
    {/uicomponent}
    {uicomponent type="submit" formId="webpage"} {#login#} {/uicomponent}
</div>
</form>
